...
const SERVICES = [
  {
    ...
    label: "Mécanique",
    icon: "🔧",
    desc: "Réparation auto, moto, vélo",
  },
  {
    id: "electricite",
    label: "Électricité",
    icon: "⚡",
    desc: "Installation, dépannage électrique",
  },
  {
    id: "fossoyeur",
    label: "Pompes Funèbres",
    icon: "🕊️",
    desc: "Inhumation, fossoyage",
  },
  {
    id: "blanchisserie",
    label: "Blanchisserie",
    icon: "👕",
    desc: "Lavage, repassage, pressing",
  },
  {
    id: "plomberie",
    label: "Plomberie",
    icon: "🚿",
    desc: "Tuyauterie, sanitaires, fuite",
  },
  {
    id: "menuiserie",
    label: "Menuiserie",
  ...
  },
  {
    ...
    label: "Coiffure",
    icon: "✂️",
    desc: "Coupe, tresse, soin capillaire",
  },
  {
    id: "jardinage",
    label: "Jardinage",
    icon: "🌿",
    desc: "Entretien jardin, élagage",
  },
  {
    id: "maconnerie",
    label: "Maçonnerie",
  ...
  },
  {
    ...
    label: "Informatique",
    icon: "💻",
    desc: "Dépannage PC, réseau",
  },
  {
    id: "peinture",
    label: "Peinture",
    icon: "🎨",
    desc: "Intérieur, extérieur, décoration",
  },
  {
    id: "cuisine",
    label: "Cuisine / Traiteur",
    icon: "🍲",
    desc: "Repas, évènements, cuisine à domicile",
  },
];
...
const MOCK_PROVIDERS = [
  {
    ...
    price: "5 000 F/h",
    avatar: "KR",
    bio: "Mécanicien expérimenté, 10 ans d'expérience, spécialisé en Toyota et Peugeot.",
    available: true,
  },
  {
    id: 2,
    ...
    price: "1 500 F/kg",
    avatar: "AB",
    bio: "Blanchisserie soignée, livraison à domicile possible dans Porto-Novo.",
    available: true,
  },
  {
    id: 3,
    ...
    price: "8 000 F/j",
    avatar: "MK",
    bio: "Électricien certifié, dépannage 24h/24 disponible.",
    available: false,
  },
  {
    id: 4,
    ...
    price: "3 000 F",
    avatar: "FD",
    bio: "Coiffeuse professionnelle, spécialisée en tresses africaines et soin.",
    available: true,
  },
  {
    id: 5,
    ...
    price: "6 000 F/h",
    avatar: "JA",
    bio: "Plombier rapide et efficace, intervention dans 1h.",
    available: true,
  },
  {
    id: 6,
    ...
    price: "À négocier",
    avatar: "PA",
    bio: "Traiteur pour événements, spécialités béninoises et internationales.",
    available: true,
  },
  {
    id: 7,
    ...
    price: "10 000 F/j",
    avatar: "KM",
    bio: "Menuisier-ébéniste, fabrication sur mesure, bois de qualité.",
    available: true,
  },
  {
    id: 8,
    ...
    price: "Sur devis",
    avatar: "RG",
    bio: "Service funèbre discret et respectueux, disponible 24h/24.",
    available: true,
  },
];
    ...
    <div style={modalOverlay}>
      <div style={{ ...modalBox, maxWidth: 500 }}>
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          <h2 style={modalTitle}>
            {step === 1 ? "👤 Votre profil" : "🛠️ Votre service"}
          </h2>
          <p style={modalSub}>
            Étape {step}/2 —{" "}
            {step === 1 ? "Informations personnelles" : "Détails du service"}
          </p>
        </div>
  ...
  return (
    <div style={modalOverlay}>
      <div style={{ ...modalBox, maxWidth: 420 }}>
        ...
        <button
          onClick={() => {
            if (!form.name || !form.phone) return alert("Champs obligatoires");
            onSuccess(form);
          }}
        ...
        {!sent ? (
            ...
            >
              ...
              <div>
                ...
                <p style={{ margin: 0, color: "#64748B", fontSize: 13 }}>
                  {SERVICES.find((s) => s.id === provider.service)?.label} ·{" "}
                  {provider.city}
                </p>
              </div>
            </div>
          ...
          <div style={{ textAlign: "center", padding: "20px 0" }}>
            ...
            <p style={{ color: "#64748B" }}>
              {provider.name} recevra votre message et vous contactera bientôt.
            </p>
            <button onClick={onClose} style={{ ...btnPrimary, marginTop: 12 }}>
              Fermer
            </button>
          </div>
        )}
...
function ProviderCard({ p, onContact }) {
  ...
  return (
    <div style={cardStyle}>
      ...
      >
        <span style={{ fontWeight: 800, color: "#0EA5E9", fontSize: 14 }}>
          {p.price}
        </span>
        <button onClick={() => onContact(p)} style={btnSmall}>
          Contacter
        </button>
      </div>
    </div>
...
export default function App() {
  ...
  const filtered = providers.filter((p) => {
    ...
    const q =
      ...
      SERVICES.find((s) => s.id === p.service)
        ?.label.toLowerCase()
    ...
    >
      ...
      >
        ...
        <nav style={{ display: "flex", gap: 6 }}>
          ...
          <button onClick={() => setModal("client")} style={btnPrimary}>
            + Inscription
          </button>
        </nav>
      </header>
      ...
      {view === "home" && (
        <main>
          ...
          >
            ...
            >
              ...
              >
                ...
                <span
                  style={{ color: "#BAE6FD", fontWeight: 600, fontSize: 12 }}
                >
                  Plateforme #1 de services au Bénin
                </span>
              </div>
              <h1
                style={{
              ...
              >
                Trouvez le bon
                <br />
                <span style={{ color: "#38BDF8" }}>prestataire</span> près de
                vous
              </h1>
              <p
                style={{
              ...
              >
                Mécanicien, électricien, blanchisserie, fossoyeur et bien plus —
                <br />
          ...
          >
            {[
              ...
              >
                ...
                <div
                  style={{ fontWeight: 900, fontSize: 24, color: "#0F172A" }}
                >
                  {num}
                </div>
                <div
          ...
          {/* CATÉGORIES */}
          <section
            style={{ maxWidth: 1080, margin: "56px auto", padding: "0 24px" }}
          >
            <h2
              style={{
                textAlign: "center",
              ...
              {SERVICES.map((svc) => (
                <div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = "0 12px 32px #0EA5E922";
                    e.currentTarget.style.borderColor = "#0EA5E9";
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.transform = "none";
                    e.currentTarget.style.boxShadow = "0 2px 8px #0000000a";
      ...
      {view === "search" && (
        <main
          style={{ maxWidth: 1080, margin: "0 auto", padding: "32px 24px" }}
        >
          <h1
            style={{
              fontWeight: 900,
          ...
          <div style={{ marginTop: 32, textAlign: "center" }}>
            <p style={{ color: "#94A3B8", fontSize: 13 }}>
              Vous êtes prestataire et pas encore inscrit ?
            </p>
            <button onClick={() => setModal("provider")} style={btnPrimary}>
              + Rejoindre ServiLink
            </button>
          </div>
        </main>
      ...
      >
        <p style={{ margin: 0 }}>
          🤝 <strong style={{ color: "#fff" }}>ServiLink Bénin</strong> —
          Plateforme de mise en relation · 2025 ·
